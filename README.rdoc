...
Effect.Glider is a Javascript glider control, based on script.aculo.us. It lets <b>content glide in and out
...
<b>The ids of these sections have to correspond to the GliderLinks' hrefs</b>, e.g. a link with href="#section1" triggers the glider
to glide div#section1 into view.
...
Currently Effect.Glider only supports Firefox and Safari.
